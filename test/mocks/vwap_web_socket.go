...
// NewVWAPWebSocket creates a new instance of VWAPWebSocket. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewVWAPWebSocket(t testing.TB) *VWAPWebSocket {
	mock := &VWAPWebSocket{}
	mock.Mock.Test(t)
